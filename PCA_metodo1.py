...
def P_C_A(X_train):
    pca_metodo1=PCA(n_components=20).fit(X_train)
    pk.dump(pca_metodo1, open("pca_metodo1.pkl","wb"))
    X_reduced=pca_metodo1.fit_transform(X_train)
    return X_reduced,pca_metodo1
...
if __name__=='__main__':
    ...
    subdirectory = 'lookback_' + str(args.lookback) + '_' + 'lookahead_' + str(args.lookahead) + '_' + 'PCA_Dataset_Metodo1'
    ...
    logging.info('Multiclass PCA train')
    ...
    logging.info('Multiclass PCA test')
