...
def P_C_A(X_train):
    ...
    pk.dump(pca, open("pca4041_20_metodo3.pkl","wb"))
...
if __name__=='__main__':
    ...
    subdirectory = 'lookback_' + str(args.lookback) + '_' + 'lookahead_' + str(args.lookahead) + '_' + 'PCA_Dataset_40_41_Metodo3'
    ...
    parser = argparse.ArgumentParser()
    parser.add_argument("-m", "--model", help="Name of BRNN model", default='MRec41_40_binned_spiketrains_lookback_12_lookahead_0_PCA_Dataset_40_41_',
                        type=str)
    parser.add_argument("--lookback", help="length of the sequence to be classified", default=12,
                        type=int)
    parser.add_argument("--lookahead", help="length of the sequence to be classified", default=0,
    ...
    model.save(data_prefix+'_MRec4041_on_MRec42')
