...
def P_C_A_Load(X_train):
    pca=pk.load(open("pca_40_41_metodo1.pkl",'rb')) 
...
if __name__=='__main__':
    ...
    subdirectory = 'lookback_' + str(args.lookback) + '_' + 'lookahead_' + str(args.lookahead) + '_' + 'PCA_Dataset_40_41_Metodo1'
    ...
    logging.info('\n')
    logging.info('Loading Mrec40 PCA model..')    
    Data_PCA=P_C_A_Load(X_data) 
    Data_PCA_Train=P_C_A_Load(X_Train)
    Data_PCA_Test=P_C_A_Load(X_Test)
