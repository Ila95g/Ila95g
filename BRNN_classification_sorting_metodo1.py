...
if __name__=='__main__':
    ...
    subdirectory = 'lookback_' + str(args.lookback) + '_' + 'lookahead_' + str(args.lookahead) + '_' + 'Sorted_Metodo1'
    ...
    parser = argparse.ArgumentParser()
    parser.add_argument("-m", "--model", help="Name of BRNN model", default='MRec40_40_binned_spiketrains_lookback_12_lookahead_0_Sorted_',
                        type=str)
    parser.add_argument("--lookback", help="length of the sequence to be classified", default=12,
                        type=int)
    parser.add_argument("--lookahead", help="length of the sequence to be classified", default=0,
    ...
    path_multi=data_prefix+'MRec40_on_MRec41'
    ...
    model.save(data_prefix+'MRec4041_on_MRec42')
