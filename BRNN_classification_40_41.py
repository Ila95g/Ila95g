...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--dataset", help="Name of dataset from previous step, without extension", default='data/MRec41_40_binned_spiketrains/lookback_12_lookahead_0_PCA_Dataset_40_41',
                        type=str)
