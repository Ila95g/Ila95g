...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model", help="Name of BRNN model", default='MRec41_40_binned_spiketrains_lookback_12_lookahead_0_PCA_Dataset_40_41_Metodo1_',
                        type=str)
    ...
    parser.add_argument("-d", "--dataset",help="Name of dataset from previous step, without extension", 
                        default='data/MRec42_40_binned_spiketrains/lookback_12_lookahead_0_PCA_Dataset_40_41_Metodo1',
                        type=str)
    ...
    testset_path = os.path.join(args.dataset, 'multi_fullset.npz')
    test_set,label_test=load_data(testset_path)
   
    
    logging.info('\n')
    logging.info('----------------')
    logging.info('Loading Multi Model')
